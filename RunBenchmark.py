...
#ENCODE_CMD, DECODE_CMD = [r'.\codec\MRP\mrp_enc.exe    {0} {1}.mrp'                                       , r'.\codec\MRP\mrp_dec.exe {0} {1}.pgm'                      ]
#ENCODE_CMD, DECODE_CMD = [r'.\codec\MRP\mrp_enc.exe -o {0} {1}.mrp'                                       , r'.\codec\MRP\mrp_dec.exe {0} {1}.pgm'                      ]
