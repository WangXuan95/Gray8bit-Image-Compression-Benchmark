...
int main(int argc, char **argv)
{
	...
	enc = init_encoder(img, num_class, num_group, prd_order, coef_precision, f_huffman, quadtree_depth, num_pmodel, pm_accuracy);
	...
	init_class(enc);
	prd_save = (int **)alloc_2d_array(enc->num_class, enc->prd_order, sizeof(int));
